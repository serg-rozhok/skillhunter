  ...
  t_forms__createArrWithAllRows(t, "t-input-group_inrow").forEach(function (t) {
    ...
    if (
      ...
      var r = t.reduce(function (t, e) {
        var o = e.classList.value.split(" ").filter(function (t) {
...
function t_forms__getMsg(t) {
  ...
  return (
    (e.EN = {
      ...
      nameua: "Please put a correct name (only cyrillic letters)",
    ...
    (e.UA = {
      ...
      nameua: "Укажите, пожалуйста, имя (только кириллица)",
...
function t_forms__onSuccess(t) {
  ...
  var m,
    ...
    d = t.querySelector(".t-form__successbox"),
    u = d ? d.getBoundingClientRect().top + window.pageYOffset : 0,
...
(window.t_forms__lang = (
  ...
  (window.tildaForm.validate = function (t) {
    ...
    for (
      ...
      var n = e[a],
        i = n.closest(".t-input-group"),
        s = n.closest(".t-conditional");
      if (
        !(
          (i && "true" === i.getAttribute("data-hidden-by-condition")) ||
          (s && "true" === s.getAttribute("data-hidden-by-condition"))
        )
      ) {
        var c = !!parseInt(n.getAttribute("data-tilda-req") || 0, 10),
          d = n.getAttribute("data-tilda-rule") || "none",
          u = "",
          m = "",
          ...
          switch (d) {
            ...
            case "nameua":
              (u = /^([А-Яа-яЁё\s]{1,}((\-)?[А-Яа-яЁё\.\s](\')?){0,})*$/i),
                w.length && !w.match(u) && _.type.push("nameua");
              break;
            case "string":
              (u =
    ...
    if ("y" === v) {
      ...
      L &&
        ...
        ((_ = { obj: {}, type: [] }).type.push("minorder"), r.push(_)),
        C &&
          window.tcart.total < window.tcart_mincntorder &&
          ((_ = { obj: {}, type: [] }).type.push("minquantity"), r.push(_));
    }
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
        ...
        for (var f = 0; f < e[m].type.length; f++) {
          ...
          (c = ""),
            (s = t.querySelector(".js-rule-error-" + _))
              ? (s.textContent && s.innerText) || !w || -1 !== d.indexOf(w)
                ? ((c = s.textContent || s.innerText),
                  -1 === d.indexOf(c) &&
                    (d = d + '<p class="t-form__errorbox-item">' + c + "</p>"))
                : (d = d + '<p class="t-form__errorbox-item">' + w + "</p>")
              : w &&
                -1 === d.indexOf(w) &&
                (d = d + '<p class="t-form__errorbox-item">' + w + "</p>"),
            n &&
              (!c && t_forms__getMsg(_ + "field")
                ? (c = t_forms__getMsg(_ + "field"))
                : w && (c = w),
              c &&
                a &&
    ...
    if (d) {
      ...
      if (
        ...
        if (h && h.length) {
          var v =
              '.t1093 .t-popup[data-tooltip-hook="' + h[h.length - 1] + '"]',
            b = document.querySelector(v),
            E = b ? getComputedStyle(b).zIndex : 0;
      ...
      if (e[d] && e[d].obj) {
        if (0 === d && "none" === e[d].obj) {
          ...
          for (var u = 0; u < i.length; u++) {
            ...
            var m = t.querySelectorAll(".t-input")[0];
            m && t_forms__moveToErrorInput(m.getAttribute("id"), i[0]);
          }
          break;
        }
        var f = e[d].obj;
        f instanceof Element || (f = f[0]),
          ...
          o &&
            ...
            s.length > 0 && (a = !0));
        for (u = 0; u < e[d].type.length; u++) {
          var _ = e[d].type[u],
            w = e[d].obj.id;
          if (
            ((l = ""), (i = t.querySelectorAll(".js-rule-error-" + _)).length)
          )
            for (var y = 0; y < i.length; y++) {
              (h = i[y]).getAttribute("data-rule-filled")
                ? (h.style.display = "block")
                : ((h.textContent && h.innerText) || !t_forms__getMsg(_)
                    ...
                    : (h.innerHTML =
                        ...
                        "</a>"),
                  (h.style.display = "block"),
                  -1 === c.indexOf(_) && t_forms__moveToErrorInput(w, h),
                  c.push(_));
            }
          else if (
            t_forms__getMsg(_) &&
          ...
          a &&
            (!l && t_forms__getMsg(_ + "field")
              ? (l = t_forms__getMsg(_ + "field"))
              : !l && t_forms__getMsg(_) && (l = t_forms__getMsg(_)),
            l &&
              o &&
              ((s = o.querySelectorAll(".t-input-error")),
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState)
            if (xhr.status >= 200 && xhr.status < 400) {
                ...
                if ("{" == o.substring(0, 1)) {
                  ...
                  if ("object" == typeof a)
                    if (a && a.message && "OK" !== a.message)
                      ...
                      var i = (n = t_forms__getErrorContainers(
                          form,
                          "Unknown error. Please, try again later."
                        )).errorBoxes,
                        s = n.allError;
              ...
              window.Tilda &&
              "function" == typeof window.Tilda.sendEventToStatistics
                ? window.Tilda.sendEventToStatistics(l, c, "", 0)
                : "undefined" != typeof ga && "tilda" !== window.mainTracker
                ? ga("send", { hitType: "pageview", page: l, title: c })
                : window.mainMetrika > "" &&
                  window[window.mainMetrika] &&
  ...
  (function () {
    try {
      ...
      if (
        ...
        for (a in n)
          "function" != typeof n[a] &&
            "utm_" == n[a].split("=")[0].substring(0, 4) &&
            (r = r + n[a] + "|||");
        if (
          r.length > 0 &&
  ...
  for (
    ...
    if (
      !(
        ...
        (a && a.getAttribute("data-hidden-by-condition"))
      )
    )
      if ("select-multiple" !== r[o].type)
        ...
        for (var n = r[o].options, i = 0; i < n.length; i++)
          n[i].selected && e.push({ name: n[i].name, value: n[i].value });
  }
  return e;
}
