      ...
      if (!i.getAttribute("data-slider-initialized")) {
        ...
        if (d) {
          ...
          if (
            ...
            var S = document.querySelector("#allrecords");
            S &&
              S.addEventListener("allRecPaddingInit", function () {
                t_slds_updateSlider(t);
              }),
...
function t_slds_animate(t, e, s) {
  ...
  requestAnimationFrame(function t_slds_animate(r) {
    var a = (r - i) / s;
    a > 1 && (a = 1);
    var d = t(a);
    e(d),
...
function t_slideMoveWithoutAnimation(t, e, s) {
  ...
  if (i) {
    ...
    if (r) {
      ...
      a > o + 1 && (a = 1);
      var c = i.classList.contains("t396__elem");
      if (c) {
        var u, _;
        if ("function" == typeof window.CustomEvent)
          var u = new CustomEvent("tildaSldsMoveSlideStart"),
            _ = new CustomEvent("tildaSldsMoveSlideEnd");
        else
          ...
          if (d) {
            ...
            if (
              ...
              E.initEvent("feedsLastSlide", !0, !0),
                ...
                t_slds_fadeIn(y, 300);
            } else q === _ && u === _ - l + 1 && t_slds_fadeOut(y, 300);
          } else
  ...
  if (e) {
    ...
    if (s) {
      ...
      if ("true" != l.getAttribute("data-slider-stop")) {
        var n = 0;
        l &&
          ((n = l.getAttribute("data-slider-items-in-row")),
          (l.style.width = a * d + "px")),
          window.innerWidth <= 640
            ? (n = 1)
            : window.innerWidth <= 960 && n > 1 && (n = 2);
        var c = n > 1 ? a / n : a;
        if (c > 0) {
          var u = e.querySelectorAll(".t-slds__item");
          l && (u = l.querySelectorAll(".t-slds__item")),
  ...
  if (a) {
    ...
    if (l) {
      var o = parseFloat(l.getAttribute("data-slider-timeout")),
        n = "",
        c = l.getAttribute("data-slider-interval-id"),
        u;
      if (
        (c && clearInterval(c), "true" !== l.getAttribute("data-slider-stop"))
      ) {
        var _;
          ...
          if ("true" !== d.getAttribute("data-swiper-initialized")) {
            ...
            if ("IntersectionObserver" in window)
              new IntersectionObserver(function (t) {
                var e = t[0];
                d.setAttribute(_, e.isIntersecting ? "" : "yes");
              }).observe(r);
            else
              stopSliderIfNeed(_),
                window.addEventListener("scroll", function () {
                  (o = !0),
                    ...
                    (l = setTimeout(function () {
                      stopSliderIfNeed(_), (o = !1);
                    }, 250));
                });
            if (1 != e) {
              var scrollPrevent = function (t) {
...
function t_slds_onHammerLoad(t, e, s) {
  if ("function" == typeof window[t]) e();
    ...
    var i = Date.now(),
      r = setTimeout(function checkFuncExist() {
        var a = Date.now();
        if ("function" != typeof window[t]) {
          if (a - i > 7e3) throw new Error(t + " is undefined");
          r = setTimeout(checkFuncExist, s || 100);
        } else e();
      });
}
