      ...
      (a.onreadystatechange = function () {
        if (4 === a.readyState)
          if (a.status >= 200 && a.status < 400) {
            ...
            o.initEvent("geoCountryLoaded", !0, !1),
...
function t_form_phonemask_initPhoneMaskForm(e, t, n) {
  ...
  if (a) {
    var o = a.querySelector('[data-input-lid="' + t + '"]');
    if (
      (o ||
        (window.tildamode && "zero" === window.tildamode
          ? (o = a.querySelector(
              '.tn-artboard [data-input-lid="' + t + '"]'
            )) || (o = a.querySelector(".tn-artboard"))
          : (o = document.querySelector('[data-input-lid="' + t + '"]')) ||
            (o = document.body)),
      !o.getAttribute("data-init-mask"))
    ) {
      t_form_phonemask__replaceInput(o),
        document.getElementById("phone-mask-style") ||
          t_form_phonemask__addStyle();
      var p = o.querySelector(".t-input-phonemask");
      if (p) {
        ("string" == typeof n && n) || (n = ""),
        ...
        if (i[n]) var r = i[n];
          ...
          var r = {
            ...
            n = "ua";
        p.setAttribute("id", "input_" + t),
          p.setAttribute("data-phonemask-iso", n),
          p.setAttribute("data-phonemask-code", n.length > 0 ? r.c : ""),
          p.setAttribute("data-phonemask-mask", n.length > 0 ? r.m : ""),
          t_form_phonemask__calcMaxlength(p);
        var s = o.querySelector(".t-input-phonemask__select-flag"),
          m = o.querySelector(".t-input-phonemask__select-code"),
          c = p.getAttribute("data-phonemask-mask"),
          l = p.getAttribute("data-phonemask-code"),
          x;
        if (n.length > 0) {
          try {
          ...
          s.setAttribute("data-phonemask-flag", n),
            ...
            t_form_phonemask__changeMinLength(
              p.getAttribute("placeholder"),
              l,
              o
            );
        }
        t_form_phonemask__addCurrentStyle(o),
          (o.querySelector(".t-input-phonemask__options-wrap").innerHTML =
            t_form_phonemask__getDrawSelector(i)),
          t_form_phonemask__initSelectEvents(a, o, i),
          o.setAttribute("data-init-mask", "yes");
      }
    }
  }
}
...
function t_form_phonemask__initSelectEvents(e, t, n) {
  ...
  function t_form_phonemask__toggleSelect() {
    if (
      ...
      m > n && c > 0
        ? ((i.style.top = "auto"), (i.style.bottom = "100%"))
        : ((i.style.bottom = "auto"), (i.style.top = "100%"));
    }
  }
  ...
  function t_form_phonemask__changeInputVal() {
    ...
    ("(" !== n && n) ||
      ...
      e.setAttribute("data-phonemask-current", n),
      t_form_phonemask__addNumberMask(
        t_form_phonemask__copypasteHandling(
          e,
          e.getAttribute("data-phonemask-without-code")
        ),
        e
      ),
      t_form_phonemask__changeVal(t, o),
      "+380" === e.getAttribute("data-phonemask-code") &&
        1 === e.value.indexOf("89") &&
        (e.value = e.value.replace("89", "9"));
  }
  ...
  function t_form_phonemask__getOutsideClick(e) {
    ...
    t || n || t_form_phonemask__activeSelectClose();
  }
    ...
    if (t) {
      ...
      if (
        ...
        for (var i in ((s = (s += e.key).replace(a, "\\$&")), n))
          t_form_phonemask__searchCountry(t, s, p, i, n[i].c);
        t_form_phonemask__scrollToCountry(t, p);
      } else if ((e.keyCode >= 65 && e.keyCode <= 90) || 32 == e.keyCode) {
        for (var i in ((s = (s += e.key).replace(a, "\\$&")), n))
          t_form_phonemask__searchCountry(t, "^" + s, p, i, n[i].n);
        t_form_phonemask__scrollToCountry(t, p);
      }
      resetTimeout();
    }
  ...
  t_form_phonemask__changeVal(t, o),
    p.addEventListener("click", t_form_phonemask__toggleSelect),
    o.addEventListener("paste", function (e) {
      ...
      if (t) {
        ...
        n &&
          ((n.value = t),
          t_form_phonemask__changeInputVal.call(n),
          e.preventDefault());
      }
    }),
    o.addEventListener("input", t_form_phonemask__changeInputVal),
    Array.prototype.forEach.call(r, function (e) {
      e.addEventListener("click", t_form_phonemask__changeOption);
    }),
...
function t_form_phonemask__addNumberMask(e, t) {
  ...
  if (i) {
    for (var s = 0; s < i.length; s++)
      "9" === i[s][0]
        ? ((r += p.slice(0, i[s].length).join("")), p.splice(0, i[s].length))
        : (r += i[s]);
...
function t_form_phonemask__chooseCountry(e, t) {
  ...
  n.focus(),
    ...
    t_form_phonemask__changeMinLength(m, p, e);
}
...
Array.prototype.some ||
  ...
  (function (e) {
    ...
    e.matches = e.matchesSelector =
      t ||
      function matches(e) {
        var matches = document.querySelectorAll(e),
          t = this;
